  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`dev-star.netlify.app`} />
        <link rel="canonical" href={`dev-star.netlify.app`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Dev Star" />
      ...
      <div className="relative flex flex-col items-center snap-mandatory min-h-screen bg-AAprimary w-full ">
        ...
        {context.sharedState.finishedLoading ? (
          <Footer
            githubUrl={"https://github.com/dev-star0102/dev-star-portfolio"}
